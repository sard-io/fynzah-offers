...
const offers = [
  { category:'russia', geo:'Russia', flag:'ru', code:'RU · 01', title:'C2C / SBP / Cards', description:'Основной RUB pay-in для Gambling, Betting и Exchange. Банки T1–T3.', rate:'9–11.5%', meta:['5k–150k','RUB','GB / BT / EX'], tone:'pink' },
  { category:'russia', geo:'Russia', flag:'ru', code:'RU · 02', title:'SBP / Cards + PDF', description:'Прием по номеру карты и СБП с подтверждением через PDF-чек.', rate:'10–12%', meta:['1k–200k','RUB','PDF receipt'], tone:'black' },
  { category:'russia', geo:'Russia', flag:'ru', code:'RU · 03', title:'NSPK Multitransfer', description:'QR НСПК с поддержкой мультипереводов и высоким лимитом.', rate:'13%', meta:['3k–200k','QR','H2H'], tone:'yellow' },
  { category:'russia', geo:'Russia', flag:'ru', code:'RU · 04', title:'Sber / Gazprom QR', description:'Внутрибанковские QR-маршруты Сбер–Сбер и Газпром–Газпром.', rate:'12.5%', meta:['100–150k','QR','GB / BT'], tone:'gray' },
  { category:'russia', geo:'Russia', flag:'ru', code:'RU · 05', title:'PSB Ecom', description:'Прямой RUB pay-in через ПСБ для Gambling и Betting трафика.', rate:'12%', meta:['1k–150k','RUB','Pay-in'], tone:'pink' },
  { category:'russia', geo:'Russia', flag:'ru', code:'RU · 06', title:'Alfa → Alfa', description:'Внутрибанковский перевод для Gambling и Betting трафика.', rate:'8.5%', meta:['10k–150k','RUB','Pay-in'], tone:'black' },
  { category:'russia', geo:'Russia', flag:'ru', code:'RU · 07', title:'C2C / SBP · Betting', description:'Отдельный pay-in маршрут по номеру карты и СБП для Betting.', rate:'6%', meta:['RUB','Betting','Contact us'], tone:'yellow' },
  { category:'cross-border', geo:'Russia / Vietnam', flag:'ru+vn', code:'XBD · 01', title:'Sber / VTB QR', description:'Cross-border QR через Сбербанк и ВТБ с расчетом в RUB.', rate:'5–11%', meta:['100–150k','RUB','GB / BT'], tone:'gray' },
  { category:'cross-border', geo:'Russia / Tajikistan', flag:'ru+tj', code:'XBD · 02', title:'YouMoney', description:'Cross-border прием через YouMoney с расчетом в RUB.', rate:'8–10.5%', meta:['1k–150k','RUB','Pay-in'], tone:'pink' },
  { category:'cross-border', geo:'Russia / Abkhazia', flag:'ru+abkhazia', code:'XBD · 03', title:'Transgran Abkhazia', description:'Cross-border RUB-маршрут через трансграничный перевод.', rate:'10.5%', meta:['1k–150k','RUB','Pay-in'], tone:'black' },
...
const solutions = [
  { code:'C2C', title:'C2C / SBP classic', text:'Основной RUB flow: карты, СБП и банки T1–T3.', tags:['5k–150k','9–11.5%','RUB'] },
  { code:'PDF', title:'SBP / Cards + PDF', text:'RUB pay-in с PDF-чеками, лимиты до 200k.', tags:['1k–200k','10–12%','Exchange / GB'] },
  { code:'NSP', title:'NSPK Multitransfer', text:'QR-оплата с мультипереводами и лимитом до 200k.', tags:['QR payment','13%','H2H'] },
  { code:'BNK', title:'Bank-to-bank QR', text:'Сбер–Сбер и Газпром–Газпром с единой ставкой.', tags:['100–150k','12.5%','RUB'] },
  { code:'VNM', title:'QR Vietnam', text:'Сбер / ВТБ QR, минимум 100 RUB, ставки от 5%.', tags:['Vietnam','5–11%','Cross-border'] },
...
const wantedGeos = [
  ...
  { code:'ET', flag:'et', region:'Africa', title:'Эфиопия', currency:'ETB', text:'Нужны mobile money и локальные pay-in / payout решения.', tags:['Mobile money','In / out'], tone:'black' },
      ...
      <section className="hero shell">
        ...
        <div className="hero-product" aria-label="Панель активных платежных направлений">
          ...
          <div className="product-card">
            ...
            <div className="product-foot"><span><small>RUB</small><b>5–13%</b></span><span><small>SETTLE</small><b>T+0</b></span><span><small>FEES</small><b>BY ROUTE</b></span></div>
          </div>
