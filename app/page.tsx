...
const offers = [
  ...
  { category:'russia', geo:'Russia / KZ', flag:'ru+kz', code:'RU · 06', title:'Bank Transfer', description:'BT-маршрут для RUB и KZT с гибким распределением трафика.', rate:'18–21%', meta:['RUB / KZT','BT','Live'], tone:'black' },
  ...
  { category:'cis', geo:'Uzbekistan', flag:'uz', code:'CIS · 02', title:'UZCARD / HUMO', description:'Локальные карты и transgran для платежей в Узбекистане.', rate:'contact us', meta:['UZS','Cards','Contact us'], tone:'gray' },
  ...
  { category:'caucasus', geo:'Armenia', flag:'am', code:'CAU · 01', title:'KZT → AMD', description:'Cross-border конверсия KZT в армянский драм.', rate:'contact us', meta:['AMD','Cross-border','Contact us'], tone:'yellow' },
  { category:'caucasus', geo:'Georgia', flag:'ge', code:'CAU · 02', title:'KZT → GEL', description:'Cross-border конверсия KZT в грузинский лари.', rate:'contact us', meta:['GEL','Cross-border','Contact us'], tone:'gray' },
...
const wantedGeos = [
  ...
  { code:'TR', flag:'tr', region:'MENA', title:'Турция', currency:'TRY', text:'Ищем local cards, bank transfer и платежные кошельки.', tags:['Local cards','Bank transfer'], tone:'black' },
];
